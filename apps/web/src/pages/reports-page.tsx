...
export function ReportsPage() {
  ...
  const salesVelocityData = useMemo(() => {
    ...
    return Object.entries(ordersByDate).map(([month, orders]) => ({
      month,
      orders,
    }))
  }, [salesOrders])
  ...
  const sortedPurchaseOrders = useMemo(() => {
    ...
    return [...purchaseOrders]
      .filter((o) => o.status === "Fulfilled" || o.status === "Received")
      .sort(
        (a, b) =>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                ...
                <p className="mt-1 text-2xl font-semibold text-destructive">
                  {products?.filter((p) => (p.stock_on_hand || 0) === 0)
                    .length || 0}
                </p>
              </div>
            </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={salesVelocityData}>
                    ...
                    <Line
                      ...
                      stroke="#1F6FEB"
                      strokeWidth={2}
                      dot={{ fill: "#1F6FEB", strokeWidth: 0, r: 4 }}
                      activeDot={{ r: 6, fill: "#1F6FEB", strokeWidth: 0 }}
                    />
                  </LineChart>
                </ResponsiveContainer>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                ...
                <p className="mt-1 text-2xl font-semibold text-green-600">
                  {purchaseOrders?.filter((o) => o.status === "Fulfilled")
                    .length || 0}
                </p>
              </div>
            </div>
